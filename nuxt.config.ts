...
export default defineNuxtConfig({
  ...
  modules: ['@unocss/nuxt', '@nuxtjs/i18n', '@nuxt/content'],
  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Crimson+Text:ital,wght@0,400;0,600;1,400&family=Inter:wght@400;500;600;700&family=Playfair+Display:ital,wght@1,700;1,900&display=swap' }
      ]
    },
    baseURL: '/'
  },
